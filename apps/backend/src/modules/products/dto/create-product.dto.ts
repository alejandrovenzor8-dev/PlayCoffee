import {
  IsString, IsNumber, IsOptional, IsBoolean, IsPositive, Min,
...
export class CreateProductDto {
  ...
  @ApiPropertyOptional() @IsNumber() @Min(0) @IsOptional() @Type(() => Number) cost?: number;
  ...
  @ApiPropertyOptional() @IsNumber() @Min(0) @IsOptional() @Type(() => Number) taxRate?: number;
